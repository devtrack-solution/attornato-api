  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    for (const perm of permissions) {
      ...
      await queryRunner.query(
        `INSERT INTO "permissions" ("id", "name", "description", "resource") VALUES ($1, $2, $3, $4) ON CONFLICT DO NOTHING`,
        [id, perm.name, perm.description, perm.resource],
      )
    }
    ...
    for (const role of roles) {
      ...
      await queryRunner.query(
        `INSERT INTO "roles" ("id", "name", "description", "level") VALUES ($1, $2, $3, $4) ON CONFLICT DO NOTHING`,
        [roleId, role.name, role.description, role.level],
      )
      ...
      for (const permName of permissionNames) {
        ...
        if (permId) {
          await queryRunner.query(
            `INSERT INTO "role_permission" ("id_role", "id_permission") VALUES ($1, $2) ON CONFLICT DO NOTHING`,
            [roleId, permId],
          )
        }
      }
