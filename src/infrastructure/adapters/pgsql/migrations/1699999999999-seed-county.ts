...
export default class SeedCounty1699999999999 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const countyNames = [
      'Abaetetuba','Acará','Ananindeua','Aurora do Pará','Barcarena','Belém','BENEVIDES','Bujarú',
      'CACHOEIRA DO ARARI','Capanema','Castanhal','COLARES','CONCORDIA','CURRALINHO','Dom Eliseu','Icoaraci','Ipixuna do Pará',
      'IRITUIA','Juizado especial de Icoaraci','MÃE DO RIO','Marituba','MAUÁ','PARÁ','Paragominas','PARAUPEBAS','Santa Izabel do Pará',
