...
import { IdentifierRepositoryOutboundPort, IdentifierRepositoryOutboundPortSymbol } from '@/domain/client/component/identifier/ports/outbound/identifier-repository.outbound-port'
