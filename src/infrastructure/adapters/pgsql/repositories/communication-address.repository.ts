...
import { CommunicationAddressRepositoryOutboundPort, CommunicationAddressRepositoryOutboundPortSymbol } from '@/domain/client/component/person/communication-address/ports/outbound/communication-address-repository.outbound-port'
