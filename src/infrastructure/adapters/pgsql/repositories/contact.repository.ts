...
import { ContactRepositoryOutboundPort, ContactRepositoryOutboundPortSymbol } from '@/domain/client/person/communication-address/contact/ports/outbound/contact-repository.outbound-port'
