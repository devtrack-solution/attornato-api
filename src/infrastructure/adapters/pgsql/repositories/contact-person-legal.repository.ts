...
import { ContactPersonLegalRepositoryOutboundPort, ContactPersonLegalRepositoryOutboundPortSymbol } from '@/domain/client/legal/contact-person-legal/ports/outbound/contact-person-repository.outbound-port'
