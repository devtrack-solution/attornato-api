...
import { ContactPersonRepositoryOutboundPort, ContactPersonRepositoryOutboundPortSymbol } from '@/domain/legal/contact-person/ports/outbound/contact-person-repository.outbound-port'
