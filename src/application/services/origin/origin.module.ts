...
import { CreateOriginInboundPortToken } from '@/domain/origin/ports/inbound/create-origin.inbound-port'
import { DeleteOriginInboundPortToken } from '@/domain/origin/ports/inbound/delete-origin.inbound-port'
import { ListOriginInboundPortToken } from '@/domain/origin/ports/inbound/list-origin.inbound-port'
import { ListToSelectOriginInboundPortToken } from '@/domain/origin/ports/inbound/list-to-select-origin.inbound-port'
import { PatchOriginInboundPortToken } from '@/domain/origin/ports/inbound/patch-origin.inbound-port'
