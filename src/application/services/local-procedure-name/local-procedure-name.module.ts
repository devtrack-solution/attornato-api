...
} from '@/application/services/local-procedure-name/create-local-procedure-name.service'
import {
...
} from '@/application/services/local-procedure-name/delete-local-procedure-name.service'
import {
...
} from '@/application/services/local-procedure-name/list-local-procedure-name.service'
import {
...
} from '@/application/services/local-procedure-name/list-to-select-local-procedure-name.service'
import {
...
} from '@/application/services/local-procedure-name/patch-local-procedure-name.service'
