...
import { CreateGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/create-group-customer.inbound-port'
import { DeleteGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/delete-group-customer.inbound-port'
...
import { ListGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/list-group-customer.inbound-port'
import { ListToSelectGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/list-to-select-group-customer.inbound-port'
...
import { PatchGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/patch-group-customer.inbound-port'
