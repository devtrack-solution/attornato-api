...
import { CreateProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/create-profile.inbound-port'
import { DeleteProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/delete-profile.inbound-port'
...
import { ListProfileService } from '@/application/services/client/profile/list-profile.service'
import { ListProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/list-profile.inbound-port'
import { ListToSelectProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/list-to-select-profile.inbound-port'
import { ListToSelectProfileService } from '@/application/services/client/profile/list-to-select-profile.service'
import { PatchProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/patch-profile.inbound-port'
