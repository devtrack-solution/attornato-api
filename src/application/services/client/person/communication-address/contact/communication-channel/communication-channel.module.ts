...
import { CreateCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/create-communication-channel.inbound-port'
import { DeleteCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/delete-communication-channel.inbound-port'
...
import { ListCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/list-communication-channel.inbound-port'
import { ListToSelectCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/list-to-select-communication-channel.inbound-port'
...
import { PatchCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/patch-communication-channel.inbound-port'
