...
import { CreateIdentifierInboundPortToken } from '@/domain/client/identifier/ports/inbound/create-identifier-responsible.inbound-port'
import { LastIdentifierInboundPortToken } from '@/domain/client/identifier/ports/inbound/last-identifier.inbound-port'
