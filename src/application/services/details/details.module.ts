...
import { ListToSelectDetailsInboundPortToken } from '@/domain/details/ports/inbound/list-to-select-details.inbound-port'
import { CreateDetailsInboundPortToken } from '@/domain/details/ports/inbound/create-details-responsible.inbound-port'
import { DeleteDetailsInboundPortToken } from '@/domain/details/ports/inbound/delete-details.inbound-port'
import { ListDetailsInboundPortToken } from '@/domain/details/ports/inbound/list-details.inbound-port'
import { PatchDetailsInboundPortToken } from '@/domain/details/ports/inbound/patch-details.inbound-port'
