...
import { CreateLocatorInboundPortToken } from '@/domain/locator/ports/inbound/create-locator.inbound-port'
import { DeleteLocatorInboundPortToken } from '@/domain/locator/ports/inbound/delete-locator.inbound-port'
import { ListLocatorInboundPortToken } from '@/domain/locator/ports/inbound/list-locator.inbound-port'
import { ListToSelectLocatorInboundPortToken } from '@/domain/locator/ports/inbound/list-to-select-locator.inbound-port'
import { PatchLocatorInboundPortToken } from '@/domain/locator/ports/inbound/patch-locator.inbound-port'
