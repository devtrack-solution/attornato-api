...
import { CreateGroupProcessInboundPortToken } from '@/domain/group-process/ports/inbound/create-group-process.inbound-port'
import { DeleteGroupProcessInboundPortToken } from '@/domain/group-process/ports/inbound/delete-group-process.inbound-port'
...
import { ListGroupProcessInboundPortToken } from '@/domain/group-process/ports/inbound/list-group-process.inbound-port'
import { ListToSelectGroupProcessInboundPortToken } from '@/domain/group-process/ports/inbound/list-to-select-group-process.inbound-port'
import { ListToSelectGroupProcessService } from '@/application/services/group-process/list-to-select-group-process.service'
import { PatchGroupProcessInboundPortToken } from '@/domain/group-process/ports/inbound/patch-group-process.inbound-port'
