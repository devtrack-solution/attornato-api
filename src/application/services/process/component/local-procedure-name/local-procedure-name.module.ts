...
import { DeleteLocalProcedureNameService } from '@/application/services/process/component/local-procedure-name/delete-local-procedure-name.service'
import { ListLocalProcedureNameInboundPortToken } from '@/domain/process/component/local-procedure-name/ports/inbound/list-local-procedure-name.inbound-port'
import { ListLocalProcedureNameService } from '@/application/services/process/component/local-procedure-name/list-local-procedure-name.service'
import { ListToSelectLocalProcedureNameInboundPortToken } from '@/domain/process/component/local-procedure-name/ports/inbound/list-to-select-local-procedure-name.inbound-port'
...
import { PatchLocalProcedureNameInboundPortToken } from '@/domain/process/component/local-procedure-name/ports/inbound/patch-local-procedure-name.inbound-port'
