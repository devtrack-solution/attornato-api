...
import { CreatePracticeAreaService } from '@/application/services/process/practice-area/create-practice-area.service'
import { ListPracticeAreaInboundPortToken } from '@/domain/process/practice-area/ports/inbound/list-practice-area.inbound-port'
import { ListPracticeAreaService } from '@/application/services/process/practice-area/list-practice-area.service'
import {
...
} from '@/application/services/process/practice-area/list-to-select-practice-area.service'
