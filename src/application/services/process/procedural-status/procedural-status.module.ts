...
} from '@/application/services/process/procedural-status/list-to-select-procedural-status.service'
...
} from '@/application/services/process/procedural-status/create-procedural-status.service'
import {
...
} from '@/application/services/process/procedural-status/delete-procedural-status.service'
import {
  ListProceduralStatusInboundPortToken
} from '@/domain/process/procedural-status/ports/inbound/list-practice-area.inbound-port'
import { ListProceduralStatusService } from '@/application/services/process/procedural-status/list-procedural-status.service'
import {
