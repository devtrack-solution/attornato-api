...
import { CreatePhaseInboundPortToken } from '@/domain/process/phase/ports/inbound/create-phase-responsible.inbound-port'
import { DeletePhaseInboundPortToken } from '@/domain/process/phase/ports/inbound/delete-phase.inbound-port'
import { ListPhaseInboundPortToken } from '@/domain/process/phase/ports/inbound/list-phase.inbound-port'
import { ListToSelectPhaseInboundPortToken } from '@/domain/process/phase/ports/inbound/list-to-select-phase.inbound-port'
import { PatchPhaseInboundPortToken } from '@/domain/process/phase/ports/inbound/patch-phase.inbound-port'
