...
import { CreateResponsibleInboundPortToken } from '@/domain/process/responsible/ports/inbound/create-responsible.inbound-port'
import { CreateResponsibleService } from './create-responsible.service'
import { DeleteResponsibleInboundPortToken } from '@/domain/process/responsible/ports/inbound/delete-responsible.inbound-port'
import { ListResponsibleInboundPortToken } from '@/domain/process/responsible/ports/inbound/list-responsible.inbound-port'
import { ListToSelectResponsibleInboundPortToken } from '@/domain/process/responsible/ports/inbound/list-to-select-responsible.inbound-port'
import { PatchResponsibleInboundPortToken } from '@/domain/process/responsible/ports/inbound/patch-responsible.inbound-port'
