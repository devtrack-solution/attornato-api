...
import { CreateOriginInboundPortToken } from '@/domain/process/origin/ports/inbound/create-origin.inbound-port'
import { DeleteOriginInboundPortToken } from '@/domain/process/origin/ports/inbound/delete-origin.inbound-port'
import { ListOriginInboundPortToken } from '@/domain/process/origin/ports/inbound/list-origin.inbound-port'
import { ListToSelectOriginInboundPortToken } from '@/domain/process/origin/ports/inbound/list-to-select-origin.inbound-port'
import { PatchOriginInboundPortToken } from '@/domain/process/origin/ports/inbound/patch-origin.inbound-port'
