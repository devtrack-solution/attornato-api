...
export class FreeField2 extends BaseBusinessObject<FreeField2Type.Repository, FreeField2Type.Output> implements IFreeField2, IValidator {
  ...
  private loadData(data: FreeField2Type.Input): FreeField2Type.Output {
    try {
      ...
      throw new EntityBadDataLoadException(new ValidationErrorResponse(`Error loading FreeField2 entity`))
    }
    return this.toJson()
  }
  ...
  static fromReference(data: { id?: string; name?: string }): FreeField2 {
    const instance = Object.create(FreeField2.prototype)
    instance._id = data.id
    instance._name = data.name ?? ''
    return instance as FreeField2
  }
