...
import { CreateGroupCustomerInboundPort, CreateGroupCustomerInboundPortToken } from '@/domain/group-customer/ports/inbound/create-group-customer.inbound-port'
import { PatchGroupCustomerInboundPort, PatchGroupCustomerInboundPortToken } from '@/domain/group-customer/ports/inbound/patch-group-customer.inbound-port'
import { DeleteGroupCustomerInboundPort, DeleteGroupCustomerInboundPortToken } from '@/domain/group-customer/ports/inbound/delete-group-customer.inbound-port'
import { ListToSelectGroupCustomerInboundPort, ListToSelectGroupCustomerInboundPortToken } from '@/domain/group-customer/ports/inbound/list-to-select-group-customer.inbound-port'
import { CreateGroupCustomerDto } from '@/presentation/controllers/http/group-customer/dtos/create-group-customer.dto'
import { PatchGroupCustomerDto } from '@/presentation/controllers/http/group-customer/dtos/patch-group-customer.dto'
import { ListToSelectGroupCustomerDto } from '@/presentation/controllers/http/group-customer/dtos/list-to-select-group-customer.dto'
import { ListGroupCustomerDto } from '@/presentation/controllers/http/group-customer/dtos/list-group-customer.dto'
import { ListGroupCustomerInboundPort, ListGroupCustomerInboundPortToken } from '@/domain/group-customer/ports/inbound/list-group-customer.inbound-port'
import { CriteriaPaginatedRequestDto } from '@/presentation/controllers/http/dtos/criteria-paginated.dto'
import { CriteriaFindByRequestDto } from '@/presentation/controllers/http/dtos/criteria-find-by.dto'

@ApiTags('Group-Customer')
@Controller('group-customer')
