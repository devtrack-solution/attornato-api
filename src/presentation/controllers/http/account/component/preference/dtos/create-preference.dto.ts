...
export class CreatePreferenceDto extends OmitType(PreferenceDto, ['userId', 'lastUpdatedUserId', 'createdUserId', 'createdAt', 'updatedAt', 'deletedAt', 'enable']) implements PreferenceType.Input {}
