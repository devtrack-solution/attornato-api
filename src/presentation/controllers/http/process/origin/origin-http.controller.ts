...
} from '@/domain/process/origin/ports/inbound/patch-origin.inbound-port'
import {
  CreateOriginInboundPort,
  CreateOriginInboundPortToken,
} from '@/domain/process/origin/ports/inbound/create-origin.inbound-port'
import {
  ListOriginInboundPort,
  ListOriginInboundPortToken,
} from '@/domain/process/origin/ports/inbound/list-origin.inbound-port'
import {
  DeleteOriginInboundPort,
  DeleteOriginInboundPortToken,
} from '@/domain/process/origin/ports/inbound/delete-origin.inbound-port'
import {
  ListToSelectOriginInboundPort,
  ListToSelectOriginInboundPortToken,
} from '@/domain/process/origin/ports/inbound/list-to-select-origin.inbound-port'
import { PatchOriginDto } from '@/presentation/controllers/http/process/origin/dtos/patch-origin.dto'
