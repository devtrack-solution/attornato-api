...
import {
  CreateDetailInboundPort,
  CreateDetailInboundPortToken,
} from '@/domain/process/component/detail/ports/inbound/create-detail-responsible.inbound-port'
import {
  ListDetailInboundPort,
  ListDetailInboundPortToken,
} from '@/domain/process/component/detail/ports/inbound/list-detail.inbound-port'
import {
  PatchDetailInboundPort,
  PatchDetailInboundPortToken,
} from '@/domain/process/component/detail/ports/inbound/patch-detail.inbound-port'
import {
  DeleteDetailInboundPort,
  DeleteDetailInboundPortToken,
} from '@/domain/process/component/detail/ports/inbound/delete-detail.inbound-port'
import {
  ListToSelectDetailInboundPort,
  ListToSelectDetailInboundPortToken,
} from '@/domain/process/component/detail/ports/inbound/list-to-select-detail.inbound-port'
