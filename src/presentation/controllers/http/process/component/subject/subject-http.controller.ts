...
} from '@/domain/process/component/subject/ports/inbound/create-subject-responsible.inbound-port'
import {
  ListSubjectInboundPort,
  ListSubjectInboundPortToken,
} from '@/domain/process/component/subject/ports/inbound/list-subject.inbound-port'
import {
  PatchSubjectInboundPort,
  PatchSubjectInboundPortToken,
} from '@/domain/process/component/subject/ports/inbound/patch-subject.inbound-port'
import {
  DeleteSubjectInboundPort,
  DeleteSubjectInboundPortToken,
} from '@/domain/process/component/subject/ports/inbound/delete-subject.inbound-port'
import {
  ListToSelectSubjectInboundPort,
  ListToSelectSubjectInboundPortToken,
} from '@/domain/process/component/subject/ports/inbound/list-to-select-subject.inbound-port'
