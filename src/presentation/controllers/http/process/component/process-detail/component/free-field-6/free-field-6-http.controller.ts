...
import { ListToSelectFreeField6InboundPortToken, ListToSelectFreeField6InboundPort } from '@/domain/process/component/process-detail/component/free-field-6/ports/inbound/list-to-select-free-field-6.inbound-port'
...
import {
  PatchFreeField6Dto
} from '@/presentation/controllers/http/process/component/process-detail/component/free-field-6/dtos/patch-free-field-6.dto'
import {
  CreateFreeField6InboundPort,
  CreateFreeField6InboundPortToken,
} from '@/domain/process/component/process-detail/component/free-field-6/ports/inbound/create-free-field-6.inbound-port'

@ApiTags('Process')
@Controller('process/free-field-6s')
