...
} from '@/domain/process/component/action-object/ports/inbound/create-action-object.inbound-port'
import {
  ListActionObjectInboundPort,
  ListActionObjectInboundPortToken,
} from '@/domain/process/component/action-object/ports/inbound/list-action-object.inbound-port'
import {
  PatchActionObjectInboundPort,
  PatchActionObjectInboundPortToken,
} from '@/domain/process/component/action-object/ports/inbound/patch-action-object.inbound-port'
import {
  DeleteActionObjectInboundPort,
  DeleteActionObjectInboundPortToken,
} from '@/domain/process/component/action-object/ports/inbound/delete-action-object.inbound-port'
import {
...
} from '@/presentation/controllers/http/process/component/action-object/dtos/list-to-select-action-object.dto'
