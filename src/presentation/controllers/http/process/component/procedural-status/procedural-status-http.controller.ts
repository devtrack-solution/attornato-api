...
} from '@/presentation/controllers/http/process/component/procedural-status/dtos/patch-practice-area.dto'
...
} from '@/presentation/controllers/http/process/component/procedural-status/dtos/list-procedural-status.dto'
import {
  ListToSelectProceduralStatusDto
} from '@/presentation/controllers/http/process/component/procedural-status/dtos/list-to-select-practice-area.dto'
