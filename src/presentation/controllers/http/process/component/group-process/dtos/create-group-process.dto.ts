...
export class CreateGroupProcessDto extends OmitType(GroupProcessDto, ['id', 'userId', 'lastUpdatedUserId', 'createdUserId', 'createdAt', 'updatedAt', 'deletedAt', 'enable']) implements GroupProcessType.Input {}
