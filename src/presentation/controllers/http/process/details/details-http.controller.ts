...
} from '@/domain/process/details/ports/inbound/create-details-responsible.inbound-port'
import {
  ListDetailsInboundPort,
  ListDetailsInboundPortToken,
} from '@/domain/process/details/ports/inbound/list-details.inbound-port'
import {
  PatchDetailsInboundPort,
  PatchDetailsInboundPortToken,
} from '@/domain/process/details/ports/inbound/patch-details.inbound-port'
import {
  DeleteDetailsInboundPort,
  DeleteDetailsInboundPortToken,
} from '@/domain/process/details/ports/inbound/delete-details.inbound-port'
import {
  ListToSelectDetailsInboundPort,
  ListToSelectDetailsInboundPortToken,
} from '@/domain/process/details/ports/inbound/list-to-select-details.inbound-port'
import { PatchDetailsDto } from '@/presentation/controllers/http/process/details/dtos/patch-details.dto'
