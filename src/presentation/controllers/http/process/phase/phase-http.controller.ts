...
import { CreatePhaseInboundPortToken, CreatePhaseInboundPort } from '@/domain/process/phase/ports/inbound/create-phase-responsible.inbound-port'
import { DeletePhaseInboundPortToken, DeletePhaseInboundPort } from '@/domain/process/phase/ports/inbound/delete-phase.inbound-port'
import { ListPhaseInboundPortToken, ListPhaseInboundPort } from '@/domain/process/phase/ports/inbound/list-phase.inbound-port'
import { ListToSelectPhaseInboundPortToken, ListToSelectPhaseInboundPort } from '@/domain/process/phase/ports/inbound/list-to-select-phase.inbound-port'
import { PatchPhaseInboundPortToken, PatchPhaseInboundPort } from '@/domain/process/phase/ports/inbound/patch-phase.inbound-port'
...
import { PatchPhaseDto } from '@/presentation/controllers/http/process/phase/dtos/patch-phase.dto'
