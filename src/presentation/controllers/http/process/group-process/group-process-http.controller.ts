...
import { CreateGroupProcessInboundPort, CreateGroupProcessInboundPortToken } from '@/domain/process/group-process/ports/inbound/create-group-process.inbound-port'
import { PatchGroupProcessInboundPort, PatchGroupProcessInboundPortToken } from '@/domain/process/group-process/ports/inbound/patch-group-process.inbound-port'
import { DeleteGroupProcessInboundPort, DeleteGroupProcessInboundPortToken } from '@/domain/process/group-process/ports/inbound/delete-group-process.inbound-port'
import { ListToSelectGroupProcessInboundPort, ListToSelectGroupProcessInboundPortToken } from '@/domain/process/group-process/ports/inbound/list-to-select-group-process.inbound-port'
import { CreateGroupProcessDto } from '@/presentation/controllers/http/process/group-process/dtos/create-group-process.dto'
import { PatchGroupProcessDto } from '@/presentation/controllers/http/process/group-process/dtos/patch-group-process.dto'
import { ListToSelectGroupProcessDto } from '@/presentation/controllers/http/process/group-process/dtos/list-to-select-group-process.dto'
import { ListGroupProcessDto } from '@/presentation/controllers/http/process/group-process/dtos/list-group-process.dto'
import { ListGroupProcessInboundPort, ListGroupProcessInboundPortToken } from '@/domain/process/group-process/ports/inbound/list-group-process.inbound-port'
