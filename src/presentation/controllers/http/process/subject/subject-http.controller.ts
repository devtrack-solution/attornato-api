...
} from '@/domain/process/subject/ports/inbound/create-subject-responsible.inbound-port'
import {
  ListSubjectInboundPort,
  ListSubjectInboundPortToken,
} from '@/domain/process/subject/ports/inbound/list-subject.inbound-port'
import {
  PatchSubjectInboundPort,
  PatchSubjectInboundPortToken,
} from '@/domain/process/subject/ports/inbound/patch-subject.inbound-port'
import {
  DeleteSubjectInboundPort,
  DeleteSubjectInboundPortToken,
} from '@/domain/process/subject/ports/inbound/delete-subject.inbound-port'
import {
  ListToSelectSubjectInboundPort,
  ListToSelectSubjectInboundPortToken,
} from '@/domain/process/subject/ports/inbound/list-to-select-subject.inbound-port'
import { CreateSubjectDto } from '@/presentation/controllers/http/process/subject/dtos/create-subject.dto'
import { ListSubjectDto } from '@/presentation/controllers/http/process/subject/dtos/list-subject.dto'
import { PatchSubjectDto } from '@/presentation/controllers/http/process/subject/dtos/patch-subject.dto'
import { ListToSelectSubjectDto } from '@/presentation/controllers/http/process/subject/dtos/list-to-select-subject.dto'
