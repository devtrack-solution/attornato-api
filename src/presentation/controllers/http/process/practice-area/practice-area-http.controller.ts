...
import {
  CreatePracticeAreaInboundPort,
  CreatePracticeAreaInboundPortToken,
} from '@/domain/process/practice-area/ports/inbound/create-practice-area.inbound-port'
import {
  ListPracticeAreaInboundPort,
  ListPracticeAreaInboundPortToken,
} from '@/domain/process/practice-area/ports/inbound/list-practice-area.inbound-port'
import {
  PatchPracticeAreaInboundPort,
  PatchPracticeAreaInboundPortToken,
} from '@/domain/process/practice-area/ports/inbound/patch-practice-area.inbound-port'
import {
  DeletePracticeAreaInboundPort,
  DeletePracticeAreaInboundPortToken,
} from '@/domain/process/practice-area/ports/inbound/delete-practice-area.inbound-port'
import {
  ListToSelectPracticeAreaInboundPort,
  ListToSelectPracticeAreaInboundPortToken,
} from '@/domain/process/practice-area/ports/inbound/list-to-select-practice-area.inbound-port'
import { CreatePracticeAreaDto } from '@/presentation/controllers/http/process/practice-area/dtos/create-practice-area.dto'
import { ListPracticeAreaDto } from '@/presentation/controllers/http/process/practice-area/dtos/list-practice-area.dto'
import { CriteriaPaginatedRequestDto } from '@/presentation/controllers/http/dtos/criteria-paginated.dto'
import { PatchPracticeAreaDto } from '@/presentation/controllers/http/process/practice-area/dtos/patch-practice-area.dto'
import {
  ListToSelectPracticeAreaDto
} from '@/presentation/controllers/http/process/practice-area/dtos/list-to-select-practice-area.dto'
