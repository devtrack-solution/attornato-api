...
import { CreatePartnerInboundPort, CreatePartnerInboundPortToken } from '@/domain/process/partner/ports/inbound/create-partner.inbound-port'
import { PatchPartnerInboundPort, PatchPartnerInboundPortToken } from '@/domain/process/partner/ports/inbound/patch-partner.inbound-port'
import { DeletePartnerInboundPort, DeletePartnerInboundPortToken } from '@/domain/process/partner/ports/inbound/delete-partner.inbound-port'
import { ListToSelectPartnerInboundPort, ListToSelectPartnerInboundPortToken } from '@/domain/process/partner/ports/inbound/list-to-select-partner.inbound-port'
import { CreatePartnerDto } from '@/presentation/controllers/http/process/partner/dtos/create-partner.dto'
import { PatchPartnerDto } from '@/presentation/controllers/http/process/partner/dtos/patch-partner.dto'
import { ListToSelectPartnerDto } from '@/presentation/controllers/http/process/partner/dtos/list-to-select-partner.dto'
import { ListPartnerDto } from '@/presentation/controllers/http/process/partner/dtos/list-partner.dto'
import { ListPartnerInboundPort, ListPartnerInboundPortToken } from '@/domain/process/partner/ports/inbound/list-partner.inbound-port'
