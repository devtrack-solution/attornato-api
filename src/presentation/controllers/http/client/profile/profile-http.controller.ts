...
import { CreateProfileInboundPort, CreateProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/create-profile.inbound-port'
import { PatchProfileInboundPort, PatchProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/patch-profile.inbound-port'
import { DeleteProfileInboundPort, DeleteProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/delete-profile.inbound-port'
import { ListToSelectProfileInboundPort, ListToSelectProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/list-to-select-profile.inbound-port'
import { ListProfileInboundPort, ListProfileInboundPortToken } from '@/domain/client/profile/ports/inbound/list-profile.inbound-port'
