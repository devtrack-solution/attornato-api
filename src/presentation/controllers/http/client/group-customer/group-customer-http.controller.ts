...
import { CreateGroupCustomerInboundPort, CreateGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/create-group-customer.inbound-port'
import { PatchGroupCustomerInboundPort, PatchGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/patch-group-customer.inbound-port'
import { DeleteGroupCustomerInboundPort, DeleteGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/delete-group-customer.inbound-port'
import { ListToSelectGroupCustomerInboundPort, ListToSelectGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/list-to-select-group-customer.inbound-port'
import { ListGroupCustomerInboundPort, ListGroupCustomerInboundPortToken } from '@/domain/client/group-customer/ports/inbound/list-group-customer.inbound-port'
...
import { ListGroupCustomerDto } from '@/presentation/controllers/http/client/group-customer/dtos/list-group-customer.dto'
import { PatchGroupCustomerDto } from '@/presentation/controllers/http/client/group-customer/dtos/patch-group-customer.dto'
import { ListToSelectGroupCustomerDto } from '@/presentation/controllers/http/client/group-customer/dtos/list-to-select-group-customer.dto'
