...
import { CreateLegalInboundPortToken, CreateLegalInboundPort } from '@/domain/client/legal/ports/inbound/create-legal.inbound-port'
import { DeleteLegalInboundPortToken, DeleteLegalInboundPort } from '@/domain/client/legal/ports/inbound/delete-legal.inbound-port'
import { ListLegalInboundPortToken, ListLegalInboundPort } from '@/domain/client/legal/ports/inbound/list-legal.inbound-port'
import { ListToSelectLegalInboundPortToken, ListToSelectLegalInboundPort } from '@/domain/client/legal/ports/inbound/list-to-select-legal.inbound-port'
import { PatchLegalInboundPortToken, PatchLegalInboundPort } from '@/domain/client/legal/ports/inbound/patch-legal.inbound-port'
