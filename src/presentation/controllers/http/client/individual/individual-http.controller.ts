...
import { CreateIndividualInboundPortToken, CreateIndividualInboundPort } from '@/domain/client/individual/ports/inbound/create-individual.inbound-port'
import { DeleteIndividualInboundPortToken, DeleteIndividualInboundPort } from '@/domain/client/individual/ports/inbound/delete-individual.inbound-port'
import { ListIndividualInboundPortToken, ListIndividualInboundPort } from '@/domain/client/individual/ports/inbound/list-individual.inbound-port'
import { ListToSelectIndividualInboundPortToken, ListToSelectIndividualInboundPort } from '@/domain/client/individual/ports/inbound/list-to-select-individual.inbound-port'
import { PatchIndividualInboundPortToken, PatchIndividualInboundPort } from '@/domain/client/individual/ports/inbound/patch-individual.inbound-port'
