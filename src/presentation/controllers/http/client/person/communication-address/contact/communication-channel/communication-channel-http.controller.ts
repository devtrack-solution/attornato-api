...
import { CreateCommunicationChannelInboundPort, CreateCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/create-communication-channel.inbound-port'
import { PatchCommunicationChannelInboundPort, PatchCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/patch-communication-channel.inbound-port'
import { DeleteCommunicationChannelInboundPort, DeleteCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/delete-communication-channel.inbound-port'
import { ListToSelectCommunicationChannelInboundPort, ListToSelectCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/list-to-select-communication-channel.inbound-port'
...
import { PatchCommunicationChannelDto } from '@/presentation/controllers/http/client/person/communication-address/contact/communication-channel/dtos/patch-communication-channel.dto'
import { ListToSelectCommunicationChannelDto } from '@/presentation/controllers/http/client/person/communication-address/contact/communication-channel/dtos/list-to-select-communication-channel.dto'
import { ListCommunicationChannelDto } from '@/presentation/controllers/http/client/person/communication-address/contact/communication-channel/dtos/list-communication-channel.dto'
import { ListCommunicationChannelInboundPort, ListCommunicationChannelInboundPortToken } from '@/domain/client/person/communication-address/contact/communication-channel/ports/inbound/list-communication-channel.inbound-port'
