...
} from '@/domain/practice-area/ports/inbound/list-practice-area.inbound-port'
import {
...
import { ListPracticeAreaDto } from '@/presentation/controllers/http/practice-area/dtos/list-practice-area.dto'
import { CriteriaPaginatedRequestDto } from '@/presentation/controllers/http/dtos/criteria-paginated.dto'
import { PatchPracticeAreaDto } from '@/presentation/controllers/http/practice-area/dtos/patch-practice-area.dto'
import {
  ListToSelectPracticeAreaDto
} from '@/presentation/controllers/http/practice-area/dtos/list-to-select-practice-area.dto'
import { CriteriaFindByRequestDto } from '@/presentation/controllers/http/dtos/criteria-find-by.dto'

@ApiTags('Practice-Area')
