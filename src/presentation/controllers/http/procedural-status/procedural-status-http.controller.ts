...
} from '@/presentation/controllers/http/procedural-status/dtos/patch-practice-area.dto'
...
} from '@/presentation/controllers/http/procedural-status/dtos/list-procedural-status.dto'
import {
  ListToSelectProceduralStatusDto
} from '@/presentation/controllers/http/procedural-status/dtos/list-to-select-practice-area.dto'
import { CriteriaFindByRequestDto } from '@/presentation/controllers/http/dtos/criteria-find-by.dto'

@ApiTags('Procedural-Status')
@Controller('procedural-statuss')
