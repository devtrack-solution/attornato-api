...
import { CreateLocatorInboundPortToken, CreateLocatorInboundPort } from '@/domain/locator/ports/inbound/create-locator.inbound-port'
import { DeleteLocatorInboundPortToken, DeleteLocatorInboundPort } from '@/domain/locator/ports/inbound/delete-locator.inbound-port'
import { ListLocatorInboundPortToken, ListLocatorInboundPort } from '@/domain/locator/ports/inbound/list-locator.inbound-port'
import { ListToSelectLocatorInboundPortToken, ListToSelectLocatorInboundPort } from '@/domain/locator/ports/inbound/list-to-select-locator.inbound-port'
import { PatchLocatorInboundPortToken, PatchLocatorInboundPort } from '@/domain/locator/ports/inbound/patch-locator.inbound-port'
