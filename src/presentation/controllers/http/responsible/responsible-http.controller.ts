...
import { CreateResponsibleInboundPortToken, CreateResponsibleInboundPort } from '@/domain/responsible/ports/inbound/create-responsible.inbound-port'
import { DeleteResponsibleInboundPortToken, DeleteResponsibleInboundPort } from '@/domain/responsible/ports/inbound/delete-responsible.inbound-port'
import { ListResponsibleInboundPortToken, ListResponsibleInboundPort } from '@/domain/responsible/ports/inbound/list-responsible.inbound-port'
import { ListToSelectResponsibleInboundPortToken, ListToSelectResponsibleInboundPort } from '@/domain/responsible/ports/inbound/list-to-select-responsible.inbound-port'
import { PatchResponsibleInboundPortToken, PatchResponsibleInboundPort } from '@/domain/responsible/ports/inbound/patch-responsible.inbound-port'
