...
import { ListToSelectFreeFieldDto } from '@/presentation/controllers/http/free-field/dtos/list-to-select-free-field.dto'
import {
  CreateFreeFieldInboundPort,
  CreateFreeFieldInboundPortToken,
} from '@/domain/free-field/ports/inbound/create-free-field.inbound-port'
import {
  ListFreeFieldInboundPort,
  ListFreeFieldInboundPortToken,
} from '@/domain/free-field/ports/inbound/list-free-field.inbound-port'
import {
  PatchFreeFieldInboundPort,
  PatchFreeFieldInboundPortToken,
} from '@/domain/free-field/ports/inbound/patch-free-field.inbound-port'
import {
  DeleteFreeFieldInboundPort,
  DeleteFreeFieldInboundPortToken,
} from '@/domain/free-field/ports/inbound/delete-free-field.inbound-port'
import {
...
import { ListFreeFieldDto } from '@/presentation/controllers/http/free-field/dtos/list-free-field.dto'
import { PatchFreeFieldDto } from '@/presentation/controllers/http/free-field/dtos/patch-free-field.dto'

@ApiTags('Free-Field')
@Controller('free-fields')
