...
import {
  ListToSelectMachineGroupDto
} from '@/presentation/controllers/http/machine/group/dtos/list-to-select-machine-group.dto'
import {
  CreateMachineGroupInboundPort,
  CreateMachineGroupInboundPortToken,
} from '@/domain/machine/group/ports/inbound/create-machine-group.inbound-port'
