...
import { CreatePrognosisInboundPort, CreatePrognosisInboundPortToken } from '@/domain/prognosis/ports/inbound/create-prognosis.inbound-port'
import { PatchPrognosisInboundPort, PatchPrognosisInboundPortToken } from '@/domain/prognosis/ports/inbound/patch-prognosis.inbound-port'
import { DeletePrognosisInboundPort, DeletePrognosisInboundPortToken } from '@/domain/prognosis/ports/inbound/delete-prognosis.inbound-port'
import { ListToSelectPrognosisInboundPort, ListToSelectPrognosisInboundPortToken } from '@/domain/prognosis/ports/inbound/list-to-select-prognosis.inbound-port'
import { CreatePrognosisDto } from '@/presentation/controllers/http/prognosis/dtos/create-prognosis.dto'
import { PatchPrognosisDto } from '@/presentation/controllers/http/prognosis/dtos/patch-prognosis.dto'
import { ListToSelectPrognosisDto } from '@/presentation/controllers/http/prognosis/dtos/list-to-select-prognosis.dto'
import { ListPrognosisDto } from '@/presentation/controllers/http/prognosis/dtos/list-prognosis.dto'
import { ListPrognosisInboundPort, ListPrognosisInboundPortToken } from '@/domain/prognosis/ports/inbound/list-prognosis.inbound-port'
