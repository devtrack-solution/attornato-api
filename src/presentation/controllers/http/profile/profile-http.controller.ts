...
import { CreateProfileInboundPort, CreateProfileInboundPortToken } from '@/domain/profile/ports/inbound/create-profile.inbound-port'
import { PatchProfileInboundPort, PatchProfileInboundPortToken } from '@/domain/profile/ports/inbound/patch-profile.inbound-port'
import { DeleteProfileInboundPort, DeleteProfileInboundPortToken } from '@/domain/profile/ports/inbound/delete-profile.inbound-port'
import { ListToSelectProfileInboundPort, ListToSelectProfileInboundPortToken } from '@/domain/profile/ports/inbound/list-to-select-profile.inbound-port'
import { CreateProfileDto } from '@/presentation/controllers/http/profile/dtos/create-profile.dto'
import { PatchProfileDto } from '@/presentation/controllers/http/profile/dtos/patch-profile.dto'
import { ListToSelectProfileDto } from '@/presentation/controllers/http/profile/dtos/list-to-select-profile.dto'
import { ListProfileDto } from '@/presentation/controllers/http/profile/dtos/list-profile.dto'
import { ListProfileInboundPort, ListProfileInboundPortToken } from '@/domain/profile/ports/inbound/list-profile.inbound-port'
